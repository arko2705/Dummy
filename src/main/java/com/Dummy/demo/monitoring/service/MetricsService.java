...
public class MetricsService {
    ...
    private final Queue<RequestMetric> recentRequests = new ConcurrentLinkedQueue<>();
    ...
    //Stream is just a collection of objects on which you can directly call multiple functions one after another to create a data processing pipeline
